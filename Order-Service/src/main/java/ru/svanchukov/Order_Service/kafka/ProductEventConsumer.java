    ...
    public class ProductEventConsumer {
        ...
        @KafkaListener(topics = "user-events", groupId = "order-group", containerFactory = "userKafkaListenerContainerFactory")
        public void listenUserEvents(com.example.User_Service.service.kafka.UserCreatedEvent event) {
            logger.info("Получено сообщение из user-events: {}", event);
        }
